...
import edu.yctc.genesis.controller.EducationController;
...
public class EducationControllerImpl implements EducationController {
    ...
    @Override
    @RequestMapping("classroom-live")
    public String showClassroomLive() {
        return TemplatePath.EDUCATION_CLASSROOM_LIVE;
    }

    @Override
    @GetMapping("import-students")
    public String showImportStudents() {
        return TemplatePath.EDUCATION_IMPORT_STUDENTS;
    }

    @Override
    @GetMapping("camera-control")
    public String showCameraControl() {
        return TemplatePath.EDUCATION_CAMERA_CONTROL;
    }
