...
function turnToReaded(newsId){
		newsId+="";
		$.ajax({
			url:"/genesis/restnews/turn-to-readed",
			type:"POST",
			data:newsId,
...
function turnToUnread(newsId){
	newsId+="";
	$.ajax({
		url:"/genesis/restnews/turn-to-unread",
		type:"POST",
		data:newsId,
		contentType:"application/json; charset=utf-8",
		dataType:'json',
...
function turnAllToReaded() {
	$.ajax({
		url:"/genesis/restnews/turn-all-to-readed",
		type:"POST",
		contentType:"application/json; charset=utf-8",
		dataType:'json',
		success:function(result){
...
function turnAllToUnread() {
	$.ajax({
		url:"/genesis/restnews/turn-all-to-unread",
		type:"POST",
		contentType:"application/json; charset=utf-8",
		dataType:'json',
		success:function(result){
...
function showNews() {
	$.ajax({
		url:"/genesis/restnews/show-news",
		type:"POST",
		contentType:"application/json; charset=utf-8",
		dataType:'json',
		success:function(result){
...
function deleteReadedNews() {
	$.ajax({
		url:"/genesis/restnews/delete-all-readed-news",
		type:"POST",
		contentType:"application/json; charset=utf-8",
		dataType:'json',
		success:function(result){
