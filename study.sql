...
) ENGINE = InnoDB AUTO_INCREMENT = 488 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学生考勤点名，算法写入' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = big5 COLLATE = big5_chinese_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_class_score`  (
  ...
  INDEX `idx_user_id`(`user_id`) USING BTREE,
  INDEX `idx_lesson_id`(`lesson_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 304 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学生上课评分，算法写入' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教室' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 255 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教室占用情况' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_classroom_state
-- ----------------------------
INSERT INTO `tb_classroom_state` VALUES (1, 1, 1, 1, '2019-03-27 21:14:37.000000', '2019-03-27 21:14:37.000000');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 380 CHARACTER SET = big5 COLLATE = big5_chinese_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `tb_lesson` VALUES (1, 1, 2, 1, '2018-09-01 22:52:12.000000', '2019-01-31 22:52:21.000000', NULL, NULL);
...
INSERT INTO `tb_permission` VALUES (26, '123', '33', '2019-12-10 23:56:35.000000', '2019-12-10 23:56:35.000000');
...
INSERT INTO `tb_permission_user` VALUES (295, NULL, NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = big5 COLLATE = big5_chinese_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 135 CHARACTER SET = big5 COLLATE = big5_chinese_ci ROW_FORMAT = Dynamic;
